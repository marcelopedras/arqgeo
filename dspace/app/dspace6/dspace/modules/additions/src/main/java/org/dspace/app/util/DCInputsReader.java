...
public class DCInputsReader
{
    ...
    /**
     * Marcelo custom - Reference the page title attribute
     */
    private Map<String, String> pageTitles = null;
            ...
            throws DCInputsReaderException
    {
        ...
        //   Marcelo custom - Init pageTitles
        pageTitles = new HashMap<String, String >();
    ...
    public String getPageTitle(String pageNum) { return pageTitles.get(pageNum); }
...
//                                         Marcelo custom - Add page title property mapped by page number in input-forms.xml
                        String pgTitle = getAttribute(npg, "title");

                        if (pgTitle != "") {
                            pageTitles.put(pgNum, pgTitle);
                        }
